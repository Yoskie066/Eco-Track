...
const AdminForgotPassword = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (adminIndex !== -1) {
      ...
      alert("Admin password reset successful! Please log in.");
      navigate("/admin-login");
    } else {
      alert("Admin email not found. Please contact system administrator.");
    }
  };
  ...
  return (
    <div className="py-20 px-6 max-w-6xl mx-auto bg-white text-black">
      ...
      >
        Reset your admin password securely below.
      </motion.p>
        ...
        >
          <div className="bg-white rounded-xl p-6 border-2 font-bold">
            <form onSubmit={handleSubmit} className="space-y-4">
              <h2 className="text-3xl font-bold text-green-600 text-center">Admin Password Reset</h2>

              <div>
                <label htmlFor="email" className="block mb-1 font-medium text-sm">Admin Email:</label>
                <input
                  type="email"
                  name="email"
                  id="email"
